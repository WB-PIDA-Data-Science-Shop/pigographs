...
Before running any scripts, restore package versions from renv.lock byr running the following chunk. From the project root:
...
Simply knit this document (README.Rmd) or, after step 1, run the following code:
