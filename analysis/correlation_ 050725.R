...
# 0.2 WDI
wdi <- read_excel(
  file.path(input_dir, "P_Data_Extract_From_World_Development_Indicators updated.xlsx"),
  sheet = "Data"
) %>%
  replace(. == "..", NA) %>%
...
# (b) first 4 w/o SSA → "appendix_nossa"
...
run_ctf_plots(ctf_country_nossa, ctf_vars_4a, ctf_labels_4a, "wdi",  "appendix_nossa")
run_ctf_plots(ctf_country_nossa, ctf_vars_4a, ctf_labels_4a, "risk", "appendix_nossa")

# (c) other 4 incl SSA → "appendix"
...
run_ctf_plots(ctf_country,    ctf_vars_4b, ctf_labels_4b, "wdi",  "appendix")
run_ctf_plots(ctf_country,    ctf_vars_4b, ctf_labels_4b, "risk", "appendix")
